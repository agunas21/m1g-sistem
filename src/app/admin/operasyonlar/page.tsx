            ...
            html5QrCode.start(
                ...
                (decodedText) => {
                    html5QrCode.stop().then(() => {
                        ...
                        handleCommandSubmit(decodedText);
                    }).catch(() => {
                        setIsScannerOpen(false);
                        handleCommandSubmit(decodedText);
                    });
                ...
                alert("Kamera başlatılamadı. İzinlerinizi kontrol edin.");
            });
            return () => {
        ...
        const portalContent = (
            <div className="fixed inset-0 bg-black/90 z-[99999] flex flex-col items-center justify-center p-4 backdrop-blur-sm">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-400 mt-2 text-sm font-light">Üye kimlik QR kodunu veya envanter barkodunu gösterin.</p>
                </div>
                <div className="w-full max-w-md bg-black rounded-3xl overflow-hidden border-2 border-white/10">
                                ...
                                <div className="xl:col-span-2 space-y-4">
                                    ...
                                    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
                                        {selectedOp.teams.map(team => {
                                            ...
                                            const members = team.members.filter(m => m.role !== "Lider");
                                                            ...
                                                            {leader && (
                                                                <div className="flex items-center justify-between text-xs bg-white/5 p-2 rounded-lg border border-red-500/10">
                                                                    <div className="flex items-center gap-2 font-bold text-red-400">
                                                                        ...
                                                                        <span>{membersData.find(m => m.id === leader.id)?.fullName || leader.id} (Lider)</span>
                                                                    </div>
                                                                    {selectedOp.status === "Aktif" && (
                                                            ...
                                                            {selectedOp.status === "Aktif" && (
                                                                ...
                                                                >
                                                                    ...
                                                                    {selectedOp.baseCamp.members.map(mId => (
                                                                        <option key={mId} value={mId}>{membersData.find(m => m.id === mId)?.fullName || mId}</option>
                                                                    ))}
                                                                </select>
                                                            )}
                                                        </div>
                                                            ...
                                                            {selectedOp.status === "Aktif" && (
                                                                ...
                                                                >
                                                                    ...
                                                                    {selectedOp.baseCamp.equipment.map(eqId => (
                                                                        <option key={eqId} value={eqId}>{inventoryData.find(i => i.id === eqId)?.name || eqId}</option>
                                                                    ))}
                                                                </select>
                                                            )}
                                                        </div>
